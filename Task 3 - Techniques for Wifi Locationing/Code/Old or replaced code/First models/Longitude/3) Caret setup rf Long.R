...
Prediction_rf_lon <- predict(rf_Fit1, newdata = wifi_test_xvalues)
postResample(Prediction_rf_lon, wifi_test_yvalues$LONGITUDE)


#add predicted values to testvalues
wifi_test_yvalues$pred_lon <- Prediction_rf_lon