...
Prediction_rf_lat <- predict(rf_Fit1, newdata = wifi_test_xvalues)
postResample(Prediction_rf_lat, wifi_test_yvalues$LATITUDE)


#add predicted values to testvalues
wifi_test_yvalues$pred_lat <- Prediction_rf_lat
