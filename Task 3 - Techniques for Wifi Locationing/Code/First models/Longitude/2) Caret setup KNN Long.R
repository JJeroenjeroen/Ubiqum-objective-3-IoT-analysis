...
Prediction_knn_lon <- predict(knn_Fit1, newdata = wifi_test_xvalues)
postResample(Prediction_knn_lon, wifi_test_yvalues$LONGITUDE)


#add predicted values to testvalues
wifi_test_yvalues$pred_lon <- Prediction_knn_lon